...
# sys.path.append('C:/Users/yanis/CSC485/parser.py')
# print(sys.path)
import numpy as np
...
from parser1 import PartialParse
from parser1 import get_sentence_from_graph
...
class TrainingIterable(object):
    ...
    def __init__(self, graphs, transducer, seed=1234, max_batch_size=2048,
        ...
        self._len = n_ex
        print("cache", self.transition_cache)
